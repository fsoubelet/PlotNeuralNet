...
arch = [
    ...
    *block_2ConvPool(
        name="b2", botton="pool_b1", top="pool_b2", s_filer=256, n_filer=128, offset="(1,0,0)", size=(32, 32, 3.5), opacity=0.5
    ),
    *block_2ConvPool(
        name="b3", botton="pool_b2", top="pool_b3", s_filer=128, n_filer=256, offset="(1,0,0)", size=(25, 25, 4.5), opacity=0.5
    ),
    *block_2ConvPool(
        name="b4", botton="pool_b3", top="pool_b4", s_filer=64, n_filer=512, offset="(1,0,0)", size=(16, 16, 5.5), opacity=0.5
    ),
    # Bottleneck
    # block-005
    to_ConvConvRelu(
